      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <div className="card">
            ...
            <div className="card-body">
              <img className="img-fluid mb-3" src="{state.image}" />
              <label className="d-block form-label" htmlFor="image">文章圖片連結</label>
              <input type="text" className="form-control" value={state.image} />          
            </div>
          </div>
        </div>
      </div>
